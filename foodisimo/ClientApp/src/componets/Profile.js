...
export default class Profile extends Component {
    constructor(props) {
        super(props)
        this.state = {   
            fields: {["name"]:"Βαγγέλης",["address"]:"Κολοκοτρώνη 124"},
            errors: {},
            profilestatus:"",
            passwordstatus:""
        };
    ...
    render() {
        return (
            <div style={this.props.currentpage ? {display:"block"} : {display:"none"}} className="profile">
                                            ...
                                            <form method="post" encType="text/plain" onSubmit= {this.profileSubmit.bind(this)}>
                                                <div className="profile-row">
                                                    <div className="profile-row-input">
                                                        <div className="form-group">
                                                           <label>Όνομα</label>
                                                           <input type="text" name="Name" onChange={this.handleChangeProfile.bind(this, "name")} value={this.state.fields["name"]}/>
                                                ...
                                                <div className="profile-row">
                                                    <div className="profile-row-input">
                                                        <div className="form-group">
                                                           <label>email</label>
                                                           <input style={{backgroundColor:"#e9ecef"}} type="text" id="email" value="as@gmail.com" readonly="readonly"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="profile-row">
                                                    <div className="profile-row-input">
                                                        <div className="form-group">
                                                           ...
                                                           <input type="text" name="Address" onChange={this.handleChangeProfile.bind(this, "address")} value={this.state.fields["address"]}  />
